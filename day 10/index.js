...
//   {
//     Heading:
//       "HTML page me JavaScript add karne ke liye kis tag ka use hota hai?",
//     Options: ["<script>", "<javascript>", "<js>", "<scripting>"],
//     answer: 0,
//   },
//   {
//     Heading:
//       "JavaScript me variable declare karne ke liye kis keyword ka use hota hai?",
//     Options: ["string", "v", "let", "constant"],
//     answer: 2,
//   },
//   {
//     Heading:
//       "CSS me background color change karne ke liye kaun si property use hoti hai?",
...
//   {
//     Heading:
//       "HTML me hyperlinks create karne ke liye kaun sa tag use hota hai?",
...
function next() {
  ...
  optionButtons.forEach((btn) => {
    if (btn.classList.contains("selected")) {
      ...
      if(
        questions[queNum - 1].Options[questions[queNum - 1].answer] 
      ){
